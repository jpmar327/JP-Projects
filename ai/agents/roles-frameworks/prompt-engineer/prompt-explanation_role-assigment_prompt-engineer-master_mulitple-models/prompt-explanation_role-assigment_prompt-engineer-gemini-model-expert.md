...
target: gemini
applies_to: [gemini-3.x, gemini-2.5]
version: "1.0"
last_updated: "2026-07-25"
description: >
  Gemini-specific prompt engineering role and framework. Prefer this file over
  the universal framework whenever the target model is Gemini (any current
  generation).
---
